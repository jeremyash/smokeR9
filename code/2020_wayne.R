...
burn_dir <- "2020_wayne_long_ridge_4_5"
...
suppressWarnings( 
  render_smoke_report(outlook_path = burn_dir, # uses directory created above to store files
                      ...
                      run_id_url = "https://playground-2.airfire.org/bluesky-web-output/15e65597902d7e-dispersion/", # on BSky Dispersion Results webpage, click on 'Results Output' and copy full URL
